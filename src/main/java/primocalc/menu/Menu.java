package primocalc.menu;

import java.util.List;
import java.util.Scanner;

import primocalc.model.Account;
import primocalc.model.AccountGoal;
...
import primocalc.service.AccountService;
import primocalc.service.RewardService;
...
public class Menu {
    ...
    private void checkAccountsMenu(){
        ...
        do {
            ...
            for(int i = 0; i < game.getAccounts().size(); i++) {
                System.out.println((i+1)+") "+game.getAccounts().get(i).getUsername());
            }
            System.out.println("0) Back");
            System.out.print("Select: ");
            ...
            if(option > 0 && option <= game.getAccounts().size()) {
                
                Account selected = game.getAccounts().get(option-1);
    ...
    private void progressMenu(Account a){
        ...
        do {
            clearScreen();
            printAccountHeader(a);
            System.out.printf("Progress - %.2f%% / 100%%%n", a.getProgressPercentage());
            System.out.println("Balance: " + a.getBalance() + "✦ (" + toWishes(a.getBalance()) + " wishes)");
            System.out.println("Goal: " + a.getCurrentGoal().getName() + " x" + a.getCurrentGoal().getQuantity() + " - " + a.getCurrentGoal().getTotalPrice() + "✦ (" + toWishes(a.getCurrentGoal().getPrice()) + " wishes)");
            ...
            System.out.printf("Achievable progress - %.2f%% / 100%%%n", a.getAchievableProgressPercentage());
    ...
    private void setRewardList(Account a){
        ...
        do {
            ...
            System.out.println("0) Back");
            System.out.print("Select to toggle: ");
